...
// In-memory cache to prevent expensive `new URL()` overhead and try/catch penalty on relative URLs.
// Bounded to typical application logo usage; memory leak risk is negligible here.
